...
function circleFive() {
    ...
    const start = document.querySelector("#start-one");
    ...
    function updateCircleWrapper() {
        ...
        const circleWrapperOne = document.querySelector(".circle-five__wrapper-one");
        const circleWrapperTwo = document.querySelector(".circle-five__wrapper-two");
        const circleWrapperThree = document.querySelector(".circle-five__wrapper-three");
        const circleWrapperFour = document.querySelector(".circle-five__wrapper-four");
        const circleWrapperFive = document.querySelector(".circle-five__wrapper-five");
        const circleWrapperSix = document.querySelector(".circle-five__wrapper-six");
